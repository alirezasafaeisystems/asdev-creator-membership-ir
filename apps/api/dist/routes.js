...
function registerPublicRoutes(app, db, opts) {
    ...
    app.post('/api/v1/subscriptions/checkout', async (req) => {
        ...
        const gateway = (0, payments_1.createMockGatewayAdapter)(opts.publicBaseUrl);
    ...
    app.get('/api/v1/payments/:gateway/callback', async (req) => {
        ...
        const adapter = (0, payments_1.createMockGatewayAdapter)(opts.publicBaseUrl);
        ...
        const applied = await (0, payments_1.applyPaymentResult)(db, { gateway: 'mock', gatewayRef, ok: verified.ok, paidAt: verified.paidAt, raw: verified.raw });
        await (0, audit_1.auditEvent)(db, {
